                    ...
                    <section>
                        <header>
                            <h2 class="text-lg font-medium text-gray-900">
                                {{ isset($category) ? __('Edit Category Information') : __('Create New Category') }}
                            </h2>

                            <p class="mt-1 text-sm text-gray-600">
                                {{ isset($category) ? __("Update the category's information.") : __("Add a new category to the system.") }}
                            </p>
                        </header>
