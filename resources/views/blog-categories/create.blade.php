<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ isset($blog) ? __('Edit Blog Category') : __('Create Blog Category') }}
        </h2>
    </x-slot>
   ...
   <div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Create Blog Category</h2>
                <p class="text-sm text-gray-500 mt-0.5">Add a new category for blog posts</p>
            </div>
        </div>
